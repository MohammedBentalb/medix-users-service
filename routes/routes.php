...
return [
    ...
    ['path' => '/api/v1/auth/refresh', 'method' => 'POST', 'public' => true, 'permissions' => [], 'roles' => []],
    ...
    ['path' => '/api/v1/auth/logout', 'method' => 'POST', 'public' => false, 'permissions' => [], 'roles' => [UserTypeEnum::USER->value]],

    ['path' => '/api/v1/users/me', 'method' => 'GET',  'public' => false, 'permissions' => [], 'roles' => [UserTypeEnum::USER->value]],
